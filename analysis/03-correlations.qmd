---
title: "Correlation analysis of Ventroposterior hypothalamus astrocytes dataset from Mickelsen LE et al 2020"
...
DOCNAME <- "correlations-within-astrocytes-dataset-from-mickelsen2020"
NOW <- Sys.time()
...
```{r params}
bioproject <- "PRJNA611624"
project <- "mickelsen2020_VPH"
cb_fpr <- 0.001
low_cutoff_gene <- 500
high_cutoff_gene <- NULL
high_cutoff_gene <- 8000
...
## Load selected astrocytes data from Mickelsen LE et al 2020
...
plt_grp_ggcorrmat <- grouped_ggcorrmat(
  ...
  annotation.args = list(
    ...
    caption = "Dataset: subset of astrocytes from the Ventroposterior hypothalamus of the mouse hypothalamus (Mickelsen LE et al 2020)"
  )
)
